...
function preload() {
  ...
  skillSystem.addSkill(new Skill("闪现", "", "demo_skill.png", 10));
  skillSystem.addSkill(new Skill("火球", "", "demo_skill.png", 18));
  skillSystem.addSkill(new Skill("护盾", "", "demo_skill.png", 12));
  skillSystem.addSkill(new Skill("治疗", "", "demo_skill.png", 10));
  skillSystem.addSkill(new Skill("冰冻", "", "demo_skill.png", 8));
  skillSystem.addSkill(new Skill("反弹", "", "demo_skill.png", 12));
